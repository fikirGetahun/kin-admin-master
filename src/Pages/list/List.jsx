...
const List = () => {
  ...
  const artistList = async () => {
    ...
    const resp = await Axios.get(endpt).then((res) => setDatas(res.data));
    console.log(resp);
  };
            ...
            {datas.map((artst) => {
              return (
                <tr key={artst.id} className="tr">
                  ...
                  <td>
                    <img src={artst.artist_avatar} />
                  </td>
                  <td>
                    <button
                      onClick={() => setArtistId(artst.id)}
                  ...
                  <td>
                    <Link to={"/users/" + artst.id} className="addbtn">
                      <button
                        onClick={() => console.log(artst.id)}
